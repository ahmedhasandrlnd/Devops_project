[![ahmedhasandrlnd](https://app.circleci.com/pipelines/github/ahmedhasandrlnd/Devops_project.svg?style=svg)](https://github.com/ahmedhasandrlnd/Devops_project)
...
Your project goal is to operationalize this working, machine learning microservice using [kubernetes](https://kubernetes.io/), which is an open-source system for automating the management of containerized applications. In this project we will:
